...
<body>
    ...
    <!--<?php
    foreach($question3_arry as $key => $value3) {
        echo '<label><input type="radio" name="Ans3" value="'.  $key . '" />'  . $value3 . '</label>' . "\n";
    }
    echo '<br>';
    ?> -->
    ...
    <form action="answer.php" method="post">
        ...
        <input type="hidden" name="Ans1" value="<?php echo $value1; ?>" />
        <input type="hidden" name="Ans2" value="<?php echo $value2; ?>" />
        <input type="hidden" name="Ans3" value="<?php echo $value3; ?>" />
        <input type="hidden" name="correctAns1" value="<?php echo $correctAns1; ?>" />
        <input type="hidden" name="correctAns2" value="<?php echo $correctAns2; ?>" />
        <input type="hidden" name="correctAns3" value="<?php echo $correctAns3; ?>" />
